            ...
            <div className="max-w-4xl mx-auto px-8">
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight mb-6 leading-tight text-left">
                <span className="bg-gradient-to-r from-primary via-primary/80 to-secondary bg-clip-text text-transparent">
                  A decentralized app that takes you closer to your financial
                  goals
                </span>
              </h1>
              <p className="text-xl text-muted-foreground max-w-3xl mb-8 text-left">
                ...
                Create, participate, and win in a transparent and secure
                environment.
              </p>
            </div>
          </div>
                    ...
                    <Card className="bg-white border-primary/20 shadow-lg hover:shadow-xl transition-shadow duration-300">
                      <CardContent className="p-8">
                        ...
                        <p className="text-sm text-muted-foreground leading-relaxed">
                          You've got a goal that you need resources for -
                          whether it's funding a project, supporting a cause, or
                          raising money for any purpose.
                        </p>
                      </CardContent>
                    </Card>
                  </div>
                  ...
                  <div className="text-center relative z-10">
                    <Card className="bg-white border-secondary/20 shadow-lg hover:shadow-xl transition-shadow duration-300">
                      <CardContent className="p-8">
                        ...
                        <h3 className="text-lg font-semibold mb-3 text-foreground">
                          Create Blockchain Raffle
                        </h3>
                        <p className="text-sm text-muted-foreground leading-relaxed">
                          We create a secure, transparent Raffle on the
                          Blockchain to help you raise funds for whatever you
                          may need.
                        </p>
                      </CardContent>
                    </Card>
                  ...
                  <div className="text-center relative z-10">
                    <Card className="bg-white border-primary/20 shadow-lg hover:shadow-xl transition-shadow duration-300">
                      <CardContent className="p-8">
                        ...
                        <p className="text-sm text-muted-foreground leading-relaxed">
                          Engage friends and family through social media to make
                          as many people as possible sign up to your Raffle!
                        </p>
                      </CardContent>
                    </Card>
                  </div>
                  ...
                  <div className="text-center relative z-10">
                    <Card className="bg-white border-tertiary/20 shadow-lg hover:shadow-xl transition-shadow duration-300">
                      <CardContent className="p-8">
                        ...
                        <div className="text-sm font-bold text-tertiary mb-3">
                          STEP 4
                        </div>
                        <h3 className="text-lg font-semibold mb-3 text-foreground">
                          Get Pink-Lit
                        ...
                        <p className="text-sm text-muted-foreground leading-relaxed">
                          Your Raffle gets Pink-Lit by reaching economic
                          viability - meaning enough participants have joined to
                          make it successful!
                        </p>
                      </CardContent>
                    </Card>
                  ...
                  <div className="text-center relative z-10">
                    <Card className="bg-white border-secondary/20 shadow-lg hover:shadow-xl transition-shadow duration-300">
                      <CardContent className="p-8">
                        ...
                        <p className="text-sm text-muted-foreground leading-relaxed">
                          When time's up or all tickets are sold, we
                          automatically select a winner using blockchain
                  ...
                  <div className="text-center relative z-10">
                    <Card className="bg-white border-primary/20 shadow-lg hover:shadow-xl transition-shadow duration-300">
                      <CardContent className="p-8">
                        ...
                        <p className="text-sm text-muted-foreground leading-relaxed">
                          Both your earnings and the winner's prize are
                          automatically transferred through the Blockchain to
                  ...
                  <div key={index} className="flex items-start gap-4">
                    ...
                    <Card className="flex-1 border-primary/20 shadow-lg">
                      <CardContent className="p-6">
                        <div className="mb-3">
                          <div
                            className={`text-sm font-bold text-${step.color} mb-2`}
                          >
                            {step.title}
                          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            <Card className="border-primary/20 hover:border-primary/40 transition-colors">
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground">
                  All raffle results are verifiable on the blockchain. No hidden
                  algorithms or manipulation possible.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-secondary/20 hover:border-secondary/40 transition-colors">
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground">
                  No single point of failure. Smart contracts handle everything
            ...
            <Card className="border-primary/20 hover:border-primary/40 transition-colors">
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground">
                  Anyone, anywhere can participate. No geographical restrictions
                  or traditional banking required.
                </p>
              </CardContent>
            </Card>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            <div className="p-6">
              <div className="text-lg font-bold text-primary mb-3">
                What if raffles are not viable by the end date?
              </div>
              <div className="text-muted-foreground">
                Then the contract will give all the ticket money back to buyers,
                no problem!
              </div>
            </div>
            <div className="p-6">
            ...
            <div className="p-6">
              <div className="text-lg font-bold text-primary mb-3">
                Do I have to create an account to take part?
              </div>
              <div className="text-muted-foreground">
                No, you just need to inform your Ethereum key, both for creating
                raffles and buying tickets
              </div>
            </div>
          </div>
        </div>
