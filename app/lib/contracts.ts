...
export const AutoRaffleABI = [
  ...
  },
  {
    ...
    outputs: [
      {
        internalType: "enum AutoRaffle.RaffleState",
        name: "",
        type: "uint8",
      },
    ],
...
export const AUTORAFFLE_ADDRESS = "AutoRaffleAddress" as const;

export const AutoRaffleFactoryABI = [
  {
    inputs: [
      {
        internalType: "address",
